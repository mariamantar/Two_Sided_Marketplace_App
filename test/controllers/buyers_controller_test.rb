...
class BuyersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create buyer" do
    assert_difference('Buyer.count') do
      post buyers_url, params: { buyer: { Profile_id: @buyer.Profile_id, User_id: @buyer.User_id, ratings: @buyer.ratings } }
    end
  ...
  test "should update buyer" do
    patch buyer_url(@buyer), params: { buyer: { Profile_id: @buyer.Profile_id, User_id: @buyer.User_id, ratings: @buyer.ratings } }
