...
class SellersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seller" do
    assert_difference('Seller.count') do
      post sellers_url, params: { seller: { User_id: @seller.User_id, listings: @seller.listings, ratings: @seller.ratings } }
    end
  ...
  test "should update seller" do
    patch seller_url(@seller), params: { seller: { User_id: @seller.User_id, listings: @seller.listings, ratings: @seller.ratings } }
